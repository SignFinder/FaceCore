...
ChatCommand* ChatHandler::getCommandTable()
{
    ...
    static ChatCommand commandTable[] =
    {
        ...
        { "announce",       SEC_GAMEMASTER,     true,  OldHandler<&ChatHandler::HandleNameAnnounceCommand>,        "", NULL },
        { "msg",            SEC_GAMEMASTER,     true,  OldHandler<&ChatHandler::HandleNameAnnounceCommand>,        "", NULL },
        { "adm",            SEC_GAMEMASTER,     true,  OldHandler<&ChatHandler::HandleAdminAnnounceCommand>,       "", NULL },
